                          ...
                          {formData.needChange === 'yes' && (
                            <div>
                              ...
                              <input
                                ...
                                onChange={handleChange}
                                className="w-full px-4 py-3 border border-yellow-300 rounded-md focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
